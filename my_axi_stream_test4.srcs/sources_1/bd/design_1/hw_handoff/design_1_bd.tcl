...
proc create_root_design { parentCell } {
  ...
  set rest_btn_in_0 [ create_bd_port -dir I rest_btn_in_0 ]
  ...
  set data_generator_0 [ create_bd_cell -type ip -vlnv user.org:user:data_generator:1.0 data_generator_0 ]

  # Create instance: my_axi_stream_master_0, and set properties
  set my_axi_stream_master_0 [ create_bd_cell -type ip -vlnv user.org:user:my_axi_stream_master:4.0 my_axi_stream_master_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_SDIO_PERIPHERAL_FREQMHZ {51} \
   ...
   CONFIG.PCW_SDIO_PERIPHERAL_DIVISOR0 {22} \
  ...
  # Create instance: rst_ps7_0_102M, and set properties
  set rst_ps7_0_102M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_0_102M ]
  ...
  connect_bd_intf_net -intf_net my_axi_stream_master_0_M00_AXIS [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins my_axi_stream_master_0/M00_AXIS]
  ...
  connect_bd_net -net data_generator_0_data_out [get_bd_pins data_generator_0/data_out] [get_bd_pins my_axi_stream_master_0/data_in]
  connect_bd_net -net data_generator_0_reset_out [get_bd_pins data_generator_0/reset_out] [get_bd_pins my_axi_stream_master_0/m00_axis_aresetn]
  connect_bd_net -net data_in_0_1 [get_bd_ports data_in_0] [get_bd_pins data_generator_0/data_in]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins data_generator_0/clk] [get_bd_pins my_axi_stream_master_0/m00_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_102M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_102M/ext_reset_in]
  connect_bd_net -net rest_btn_in_0_1 [get_bd_ports rest_btn_in_0] [get_bd_pins data_generator_0/rest_btn_in]
  connect_bd_net -net rst_ps7_0_102M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins rst_ps7_0_102M/peripheral_aresetn]
