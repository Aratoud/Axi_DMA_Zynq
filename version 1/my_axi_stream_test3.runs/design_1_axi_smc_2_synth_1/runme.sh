...
HD_PWD='/home/umram/my_axi_stream_test3/my_axi_stream_test3.runs/design_1_axi_smc_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_smc_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_smc_2.tcl
