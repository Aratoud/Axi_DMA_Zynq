...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA2_PERIPHERAL_FREQMHZ {51} \
   ...
   CONFIG.PCW_FCLK2_PERIPHERAL_DIVISOR0 {22} \
  ...
  set sample_generator_0 [ create_bd_cell -type ip -vlnv user.org:user:sample_generator:3.0 sample_generator_0 ]
  ...
  connect_bd_intf_net -intf_net sample_generator_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins sample_generator_0/M_AXIS]

  # Create port connections
  connect_bd_net -net Data_In_0_1 [get_bd_ports Data_In_0] [get_bd_pins sample_generator_0/Data_In]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_102M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK2] [get_bd_pins sample_generator_0/m_axis_aclk]
  ...
  connect_bd_net -net rst_ps7_0_102M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_102M/peripheral_aresetn] [get_bd_pins sample_generator_0/m_axis_aresetn]
