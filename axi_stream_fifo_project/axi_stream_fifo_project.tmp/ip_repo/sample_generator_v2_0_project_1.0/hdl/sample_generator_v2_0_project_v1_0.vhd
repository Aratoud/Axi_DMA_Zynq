...
entity sample_generator_v2_0_project_v1_0 is
	generic (
...
end sample_generator_v2_0_project_v1_0;

architecture arch_imp of sample_generator_v2_0_project_v1_0 is
	...
	component sample_generator_v2_0_project_v1_0_M_AXIS is
		generic (
		C_M_AXIS_TDATA_WIDTH	: integer	:= 32;
	...
	end component sample_generator_v2_0_project_v1_0_M_AXIS;

begin

-- Instantiation of Axi Bus Interface M_AXIS
sample_generator_v2_0_project_v1_0_M_AXIS_inst : sample_generator_v2_0_project_v1_0_M_AXIS
	generic map (
    ...
    process(one_hertz_clk)
    begin 
        if rising_edge(one_hertz_clk) then
